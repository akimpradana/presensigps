                    ...
                    <div class="card">
                        <div class="card-body">
                            @if(Session::get('success'))
                                ...
                                @endif
                        <form action="{{ url('/konfigurasi/updatejamkerja') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" value="{{$jamKerja->jam_masuk}}" class="form-control" placeholder="jam masuk" id="jam_masuk" name="jam_masuk" aria-label="Search in website">
                                      </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mt-3">
                                        ...
                                        <input type="text" value="{{$jamKerja->jam_pulang}}" class="form-control" placeholder="jam pulang" id="jam_pulang" name="jam_pulang" aria-label="Search in website">
                                      </div>
                                </div>
                            </div>
                            <div class="row mt-3">
