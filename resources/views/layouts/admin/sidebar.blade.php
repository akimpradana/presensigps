      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{request()->is(['karyawan', 'jabatan']) ? 'show' : ''}}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{request()->is(['karyawan', 'jabatan']) ? 'true' : ''}}" >
            ...
            <div class="dropdown-menu {{request()->is(['karyawan', 'jabatan', 'cuti']) ? 'show' : ''}}">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item {{request()->is(['karyawan']) ? 'show' : ''}}" href="/karyawan">
                    Data Karyawan
                  </a>
                  <a class="dropdown-item {{request()->is(['jabatan']) ? 'show' : ''}}" href="/jabatan">
                    Jabatan
                  </a>
                  <a class="dropdown-item {{request()->is(['cuti']) ? 'show' : ''}}" href="/cuti">
                    Cuti
                  </a>
                </div>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link {{request()->is('presensi/presensikaryawan')?'active':''}}" href="/presensi/presensikaryawan" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{request()->is(['lokasikantor', 'jamkerja']) ? 'show' : ''}}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{request()->is(['jamkerja', 'lokasikantor']) ? 'true' : ''}}" >
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5" /><path d="M12 12l8 -4.5" /><path d="M12 12l0 9" /><path d="M12 12l-8 -4.5" /><path d="M16 5.25l-8 4.5" /></svg>
              </span>
              <span class="nav-link-title">
            ...
            <div class="dropdown-menu {{request()->is(['lokasikantor', 'jamkerja']) ? 'show' : ''}}">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item {{request()->is(['lokasikantor']) ? 'show' : ''}}" href="/konfigurasi/lokasikantor">
                    Lokasi Kantor
                  </a>
                  <a class="dropdown-item {{request()->is(['jamkerja']) ? 'show' : ''}}" href="/konfigurasi/jamkerja">
                    Jam Kerja
                  </a>
                </div>
              </div>
