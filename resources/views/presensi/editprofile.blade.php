...
<form action="/presensi/{{$karyawan->nik}}/updatefile" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                <input type="password" class="form-control" name="password_confirmation" placeholder="Ulangi Password" autocomplete="off">
            </div>
        </div>
